...
import com.datlinq.datafiniti.response.DatafinitiError.AccessDenied
...
/**
  ...
  */
class AccessDeniedTest extends FunSuite {

  val e = AccessDenied(101, "data", "http://datlinq.com")
