...
import com.datlinq.datafiniti.response.DatafinitiError.ExceededPreviewLimit
...
/**
  ...
  */
class ExceededPreviewLimitTest extends FunSuite {

  val e = ExceededPreviewLimit(101, "data", "http://datlinq.com")
